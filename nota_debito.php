...
<head>
    ...
    <title>Emitir | Nota de Débito</title>
    <!-- Favicon-->
...
<body class="theme-indigo">
 <?php include'Componentes/pantalla_cargando.php'; ?>
                            ...
                            <div id="div_fila_detalle_1" class="row clearfix">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Cant. (*)</small>
                                            <input id="cantidad_1" name="1" data-tipodte="56" type="number" min="0" class="form-control" placeholder="1" required onchange="calcularSubtotal(this)" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Precio (*)</small>
                                            <input id="precio_1" name="1" data-tipodte="56" type="number" min="0" class="form-control" placeholder="$ 0" required onchange="calcularSubtotal(this)"/>
                                        </div>
                                    </div>
                                </div>                                
                                <div class="col-sm-2">
    ...
    <script type="text/javascript">  
        ...
        $("#lista_emitir_dte_nota_debito_menu").addClass("active");
