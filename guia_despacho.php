...
<head>
    ...
    <title>Emitir | Guía de Despacho</title>
    <!-- Favicon-->
...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>EMITIR GUÍA DE DESPACHO ELECTRÓNICA</h2>
            </div>
            <!-- Input -->
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <select id="select_forma_pago" class="form-control show-tick">                                        
                                ...
                                <div class="col-sm-6">
                                    <small> Tipo de traslado (*)</small>
                                    <select id="select_codigo_traslado" class="form-control show-tick">
                                        <option value="0">Ninguno</option>
                                        <option value="1">Exportador</option>
                                        <option value="2">Agente de aduana</option>
                                        <option value="3">Vendedor</option>   
                                        <!--<option value="4">Contribuyente autorizado</option>-->                                      
                                    </select>
                                </div>                              
                                </div>
                                 <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="tipo_venta" class="form-control show-tick">                                        
                                        <option value="0">Ninguno</option>
                                        <option value="1">Ventas del Giro</option>
                                        <option value="2">Venta Activo Fijo</option>
                                        <option value="3">Venta Bien Raiz</option>                                        
                                    </select>
                                </div>                               
                                </div>
                            </div>
                                ...
                                <div class="col-sm-3">                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input id="rut_receptor" type="text" class="form-control"  onchange="checkRut(this)" />
                                        </div>
                                    </div>
                                </div>  
                                <div class="col-sm-5">                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input id="razon_social_receptor" type="text" class="form-control"  />
                                        </div>
                                    </div>                                    
                                </div>
                                 <div class="col-sm-4">
                                     <div class="form-group">                     
                                    <small>Giro (*)</small>
                                        <!-- llenar con giros de la BD-->
                                        <!-- <select id="giro_receptor" class="form-control show-tick">                                                                                   
                                        </select> -->
                                     <div class="form-line">   
                                    <input id="input_giro_receptor" placeholder="Selecione Giro" class="form-control" type="text" list="giro_receptor" />
                                    </div>
                                    <datalist id="giro_receptor">
                            ...
                            <div class="row clearfix">
                                 <div class="col-sm-6">                                   
                                    <div class="form-group">
                                        ...
                                        <!-- llenar con giros de la BD-->
                                        <!-- <select id="direccion_receptor" class="form-control show-tick" onchange="cargarComuna()">
                                                                                   
                                        </select>       -->  
                                        <div class="form-line">   
                                         <input id="input_direccion_receptor" placeholder="Seleccione Dirección" onchange="cargarComuna()" class="form-control" type="text" list="direccion_receptor" />   
                                     </div>
                                    <datalist id="direccion_receptor" >
                                ...
                                <div class="col-sm-3">                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                             <small>Comuna (*)</small>
                                            <input id="comuna_receptor" type="text" class="form-control" />
                                        </div>
                                    </div>
                                </div>                                                                       
                            </div>                           
            ...
            <!-- DATOS TRANSPORTE -->
            <div class="row clearfix" id="div_transporte">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>TRANSPORTE</h2>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <small> Tipo de Despacho (*)</small>
                                    <select id="select_tipo_despacho" class="form-control show-tick">                                        
                                ...
                                <div class="col-sm-6">
                                    <small> Indicador Traslado (*)</small>
                                    <select id="select_ind_traslado" class="form-control show-tick">
                                        <option value="0">- Seleccione -</option>
                                        <option value="1">Operacion cosntituye venta</option>
                                        ...
                                        <option value="7">Guia de devolución</option>                                     
                                    </select>
                                </div>                              
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-6">                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Dirección de Destino (*)</small>
                                            <input id="direccion_destino" type="text" class="form-control" placeholder="Ejemplo: Pasaje las Barracas 1243"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Comuna Destino (*)</small>
                                            <input id="comuna_destino" type="text" class="form-control" placeholder="Ejemplo: La Serena"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input id="ciudad_destino" type="text" class="form-control" placeholder="Ejemplo: La Serena"/>
                                        </div>
                                    </div>
                                </div>                                                             
                            </div>
                            ...
                            <div id="div_fila_detalle_1" class="row clearfix">
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Código</small>
                                            <input id="codigo_1" name="1" type="text" class="form-control" placeholder="--" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Cant. (*)</small>
                                            <input id="cantidad_1" name="1" data-tipodte="52" type="number" min="0" class="form-control" placeholder="1" required onchange="calcularSubtotal(this)" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Precio (*)</small>
                                            <input id="precio_1" name="1" data-tipodte="52" type="number" min="0" class="form-control" placeholder="$ 0" required onchange="calcularSubtotal(this)"/>
                                        </div>
                                    </div>
                                </div>                                
                                <div class="col-sm-2">
            ...
            <!-- #END# TOTALES -->  
            <div class="auto" id="tipo_dte" style="display: none">52</div>          
    ...
    <script type="text/javascript"> var tipo_dte = "52"; </script>

    <script type="text/javascript"> 

         $("#lista_emitir_dte_guia_despacho_menu").addClass("active");
