...
<head>
    ...
    <title>Emitir | Boleta Exenta</title>
    <!-- Favicon-->
...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>EMITIR BOLETA EXENTA ELECTRÓNICA</h2>
            </div>
            <!-- Input -->
                            ...
                            <div id="div_fila_detalle_1" class="row clearfix">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Cant. (*)</small>
                                            <input id="cantidad_1" name="1" data-tipodte="41" type="number" min="0" class="form-control" placeholder="1" required onchange="calcularSubtotal(this)" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Precio (*)</small>
                                            <input id="precio_1" name="1" data-tipodte="41" type="number" min="0" class="form-control" placeholder="$ 0" required onchange="calcularSubtotal(this)"/>
                                        </div>
                                    </div>
                                </div>                                
                                <div class="col-sm-2">
            ...
            <!-- #END# TOTALES -->  
            <div class="auto" id="tipo_dte" style="display: none">41</div>          
    ...
    <script type="text/javascript"> var tipo_dte = "41"; </script>

    <script type="text/javascript"> 

         $("#lista_emitir_dte_boleta_exdenta_menu").addClass("active");
