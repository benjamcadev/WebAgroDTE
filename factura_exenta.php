...
<head>
    ...
    <title>Emitir | Factura Exenta</title>
    <!-- Favicon-->
...
<body class="theme-indigo">
  <?php include'Componentes/pantalla_cargando.php'; ?>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>EMITIR FACTURA EXENTA ELECTRÓNICA</h2>
            </div>
            <!-- Input -->
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <small> Tipo de compra (*)</small>
                                    <select id="select_tipo_compra" class="form-control show-tick">
                                        <option value="0">Ninguno</option>
                                        <option value="1">Compras del giro</option>
                                        <option value="2">Compras en supermercados o similares</option>
                                        <option value="3">Adquisición bien raiz</option>   
                                        <option value="4">Compra activo fijo</option> 
                                        <option value="5">Compra con IVA uso común</option>
                                        <option value="6">Compra sin derecho a crédito</option>
                                        <option value="7">Compra que no corresponde incluir</option>                                        
                                    </select>
                                </div>                              
                                </div>
                                 <div class="row clearfix">
                            ...
                            <div id="div_fila_detalle_1" class="row clearfix">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Cant. (*)</small>
                                            <input id="cantidad_1" name="1" data-tipodte="34" type="number" min="0" class="form-control" placeholder="1" required onchange="calcularSubtotal(this)" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <small> Precio (*)</small>
                                            <input id="precio_1" name="1" data-tipodte="34" type="number" min="0" class="form-control" placeholder="$ 0" required onchange="calcularSubtotal(this)"/>
                                        </div>
                                    </div>
                                </div>                                
                                <div class="col-sm-2">
                           ...
                           <div class="row clearfix">
                               <div class="col-sm-12">
                                  <button type="button" class="btn btn-primary waves-effect">
                                    ...
                                    <span id="pdf_nombre">factura_exenta.pdf</span>
                                </button>
                                 <button type="button" class="btn btn-primary waves-effect">
                                    <i class="material-icons">content_copy</i>
                                    <span id="xml_nombre">factura_exenta.xml</span>
                                </button>
                               </div>
                           </div>
                            <div class="row clearfix">
    ...
    <script type="text/javascript"> var tipo_dte = "34"; </script>
    ...
    <script type="text/javascript"> 
        ...
        $("#lista_emitir_dte_factura_exenta_menu").addClass("active");
