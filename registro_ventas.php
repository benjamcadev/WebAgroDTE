...
<head>
    ...
    <title>Registro de Ventas | AgroDTE</title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h3>
                   REGISTRO DE VENTAS
                    <small>En este menu encontraras un resumen de la cantidad vendida por mes de cada DTE</small>
                </h3>
            </div>
            <!-- Basic Examples -->
 ...
 <!-- Select Plugin Js -->
    ...
    $('[data-toggle="tooltip"]').tooltip({
        container: 'body'
            ...
            dataType: "json",
            url: "Clases/Registros.php?funcion=consultarVentasRegistro",
            success:function(data){
